...
export function SosBottomSheet({ sos, cancelSOS }: Props) {
  ...
  // Bounce the countdown digit on each change
  useEffect(() => {
  ...
  // Pulse ring animation in active phase
  useEffect(() => {
    if (sos.phase !== "active") {
  ...
  return (
    <View style={StyleSheet.absoluteFill} pointerEvents="box-none">
      {/* Semi-transparent backdrop — cannot be tapped to dismiss SOS */}
          ...
          <View style={styles.countdownWrap}>
            ...
            <View style={{ alignItems: "center", paddingTop: 8, paddingBottom: 24, paddingHorizontal: 24 }}>
              ...
              <View style={styles.cdCircleWrap}>
                ...
                <Animated.Text
                  style={[styles.cdNumber, { transform: [{ scale: bounceAnim }] }]}
                >
              ...
              {sos.loading && (
                <Text style={styles.cdGps}>{t("sos.gettingLocation")}</Text>
              )}
          ...
          >
            ...
            <View style={styles.activeHeader}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={[styles.activeSub, { color: c.textMuted }]}>{t("sos.helpComing")}</Text>
              </View>
              <Text style={[styles.activeTimer, { color: c.accent }]}>{fmtClock(sos.seconds)}</Text>
            </View>

            {/* Notice */}
            <View style={[styles.notice, { backgroundColor: c.cardAlt, borderColor: c.border }]}>
              <Icon name="info" size={14} color={c.textMuted} />
              <Text style={[styles.noticeText, { color: c.textMuted }]}>{t("sos.notConfigured")}</Text>
            </View>
              ...
              <View style={styles.panelRow}>
                ...
                {sos.shareUrl && (
                  <View style={[styles.liveBadge, { backgroundColor: c.successSoft }]}>
                    ...
                    <Text style={[styles.liveBadgeText, { color: c.success }]}>
                      {t("sos.liveTrackingOn")}
                    </Text>
                  </View>
                )}
              </View>
